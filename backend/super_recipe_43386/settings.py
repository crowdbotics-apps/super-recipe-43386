"""
Django settings for super_recipe_43386 project.
...
ROOT_URLCONF = 'super_recipe_43386.urls'
...
WSGI_APPLICATION = 'super_recipe_43386.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_recipe_43386 API",
    "DESCRIPTION": "API documentation for super_recipe_43386 App",
    "VERSION": "v1",
}
